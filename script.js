...
function validaCPF(cpf) {
    if (cpf.length != 11){
        ...
        // soma é menor qeu 2 SE for igual a zero SENAO 11 - (soma % 11)
...
function validacao() {
    ...
    //ppuxando o valor do html pelo id='cpf_digitado
    var resultadoValidacao = validaCPF(cpf);

    if(resultadoValidacao){// para validar se é false ou true, basta colocar o nome,não é necessario realizar a comparação
